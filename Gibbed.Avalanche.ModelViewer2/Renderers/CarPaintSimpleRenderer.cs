...
namespace Gibbed.Avalanche.ModelViewer2.Renderers
{
    internal class CarPaintSimpleRenderer : GenericBlockRenderer<CarPaintSimple>
    {
        ...
        */
        ...
        public override void Setup(SlimDX.Direct3D10.Device device, CarPaintSimple block, string basePath)
        {
            /*
        ...
        public override void Render(SlimDX.Direct3D10.Device device, CarPaintSimple block)
        {
            /*
