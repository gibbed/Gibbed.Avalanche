...
namespace Gibbed.Avalanche.ModelViewer2.Renderers
{
    internal class CarPaintRenderer : GenericBlockRenderer<CarPaint>
    {
        ...
        */
        ...
        public override void Setup(SlimDX.Direct3D10.Device device, CarPaint block, string basePath)
        {
            /*
        ...
        public override void Render(SlimDX.Direct3D10.Device device, CarPaint block)
        {
            /*
